...
CREATE TABLE `agendamentos` (
  ...
  `forma_pagamento` enum('Transferencia Bancaria','Apolice','Carteiras Moveis') NOT NULL,
  `dia` date NOT NULL,
...
(16, 61, '', '2024-08-19', '08:00:00', 29, '2024-08-14 14:10:03', '2024-08-14 14:11:30'),
(17, 62, '', '2024-08-19', '08:31:00', 31, '2024-08-14 15:19:23', '2024-08-14 15:19:57'),
(18, 63, '', '2024-08-19', '09:02:00', 33, '2024-08-14 18:11:13', '2024-08-14 18:11:56'),
(20, 65, '', '2024-09-02', '11:37:00', 36, '2024-08-15 05:53:13', '2024-08-15 05:53:56'),
(21, 66, '', '2024-09-09', '11:37:00', 37, '2024-08-15 09:51:04', '2024-08-15 09:52:36'),
(22, NULL, 'Transferencia Bancaria', '2025-01-20', '08:00:00', 27, '2025-01-12 14:11:50', '2025-01-12 14:11:50'),
(23, NULL, 'Apolice', '2025-01-13', '08:31:00', 31, '2025-01-12 14:12:49', '2025-01-12 14:12:49');

-- --------------------------------------------------------

--
-- Table structure for table `agendamento_disponibilidade`
--
...
--
-- Dumping data for table `agendamento_disponibilidade`
--
...
(22, 22, 31, '2025-01-12 14:11:50', '2025-01-12 14:11:50'),
(23, 23, 30, '2025-01-12 14:12:49', '2025-01-12 14:12:49');
...
(1, NULL, NULL, 'Cirurgião', 600.00, 'images.jpg'),
...
--
-- Table structure for table `gravidades`
--
...
--
-- Dumping data for table `gravidades`
--
...
(250, '2025_01_05_143927_update_forma_pagamento_in_agendamentos_table', 21);
...
--
-- Table structure for table `status_consultas`
--
...
--
-- Dumping data for table `status_consultas`
--
...
(10, 'Ana Alcinda Chauque', 'alcinya677@gmail.com', NULL, '$2y$12$sn3mlrEhq934S.FAscwA7ecIGqm3PNLB8Yk9kSC47rDAP0cMzCdqi', NULL, '2025-01-12 14:08:44', '2025-01-12 14:08:44', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `via_administracaos`
--
...
--
-- Dumping data for table `via_administracaos`
--
...
--
-- Indexes for table `agendamento_disponibilidade`
--
...
--
-- Indexes for table `status_consultas`
--
...
--
-- Indexes for table `via_administracaos`
--
...
--
-- AUTO_INCREMENT for table `agendamento_disponibilidade`
--
ALTER TABLE `agendamento_disponibilidade`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
-- AUTO_INCREMENT for table `prescricao_medicamento`
--
ALTER TABLE `prescricao_medicamento`
...
--
-- AUTO_INCREMENT for table `status_consultas`
--
ALTER TABLE `status_consultas`
...
--
-- AUTO_INCREMENT for table `via_administracaos`
--
ALTER TABLE `via_administracaos`
...
--
-- Constraints for table `agendamento_disponibilidade`
--
ALTER TABLE `agendamento_disponibilidade`
...
--
-- Constraints for table `prescricao_medicamento`
--
ALTER TABLE `prescricao_medicamento`
...
--
-- Constraints for table `status_consultas`
--
ALTER TABLE `status_consultas`
