    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="forma_farmaceutica" name='forma_farmaceutica' value="{{ $medicamento->forma_farmaceutica_descricao }}" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="via_administracao" name='via_administracao' value="{{ $medicamento->via_administracao_descricao }}" readonly>
            </div>

            <div class="form-group">
                <label for="fabricante">Fabricante</label>
                <input type="text" class="form-control" id="fabricante" name='fabricante' value="{{ $medicamento->fabricante_nome }}" readonly>
            </div>
