        ...
        <form action="{{ url('saveMedicamento') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="indicacoes" name='indicacoes' placeholder="Digite as indicações..."></textarea>
                </div>

                <div class="form-group">
                    <label for="contraindicacoes">Contraindicações</label>
                    <textarea class="form-control" id="contraindicacoes" name='contraindicacoes' placeholder="Digite as contraindicações..."></textarea>
                </div>

                <div class="form-group">
                    <label for="efeitos_colaterais">Efeitos Colaterais</label>
                    <textarea class="form-control" id="efeitos_colaterais" name='efeitos_colaterais' placeholder="Digite os efeitos colaterais..."></textarea>
                </div>

                <div class="form-group">
                    <label for="instrucoes_uso">Instruções de Uso</label>
                    <textarea class="form-control" id="instrucoes_uso" name='instrucoes_uso' placeholder="Digite as instruções de uso..."></textarea>
                </div>

                <div class="form-group">
                    <label for="armazenamento">Armazenamento</label>
                    <textarea class="form-control" id="armazenamento" name='armazenamento' placeholder="Digite as instruções de armazenamento..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="disponibilidade" name="disponibilidade">
                        ...
                        @foreach ($disponibilidades as $disponibilidade)
                            <option value="{{ $disponibilidade }}">{{ ucfirst($disponibilidade) }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
